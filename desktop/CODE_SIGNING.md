...
3. Add these GitHub Actions repository secrets:
   - `CREW_SHIP_CODE_SIGN_PFX_BASE64`: the base64 encoding of the `.pfx` file.
   - `CREW_SHIP_CODE_SIGN_PFX_PASSWORD`: its export password.
4. Optionally add `CREW_SHIP_TIMESTAMP_URL`; otherwise the workflow uses DigiCert's timestamp service.
